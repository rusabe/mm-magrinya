...
================================================== -->
  <body>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">M&amp;M Instal&middot;lacions</a>
            </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="images/carousel-1.jpg" alt="Servei integral">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="images/carousel-3.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>M&amp;M Instal&middot;lacions</h1>
    ...
    <div class="container footer">
      <!-- FOOTER -->
      <footer>
        <p class="pull-right"><a href="#">Inici</a></p>
        <p>P&agrave;gina dissenyada per <a href="http://ruben.barcelona">Rub&eacute;n S&agrave;ez</a></p>
      </footer>
    </div>
